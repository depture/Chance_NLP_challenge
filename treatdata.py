...
tfVec = pickle.load(open("Chance_NLP_challenge/tfidf.pickle.dat", "rb"))
X_tfidf = tfVec.transform(subject_comments_1).todense()

CountVect = pickle.load(open("Chance_NLP_challenge/CountVect.pickle.dat", "rb"))
X_vectorized = CountVect.transform(subject_comments_1).toarray()

X_concat = np.column_stack((X_tfidf, X_vectorized))

# load model from file
loaded_model = pickle.load(open("Chance_NLP_challenge/model.pickle.dat", "rb"))
